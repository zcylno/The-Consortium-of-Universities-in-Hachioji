...
def plot(count, data1, data2, data3, data4, data5, data6, data7, data8):
    ...
    plt.plot(count,data1,color='red', label='color1')
    plt.plot(count,data2,color='green', label='color2')
    plt.plot(count,data3,color='blue', label='color3')
    plt.plot(count,data4,color='black', label='color4')
    plt.plot(count, data5, color='#646464', label='color5')
    plt.plot(count, data6, color='#969696', label='color6')
    plt.plot(count, data7, color='#c8c8c8', label='color7')
    plt.plot(count, data8, color='#fafafa', label='color8')
    plt.legend()  # 显示图例
    name = count[0]
