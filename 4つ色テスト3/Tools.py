...
def plot(count,data1,data2,data3,data4):
    plt.figure(2)
    plt.clf()
    plt.xlabel('times')
    plt.ylabel('cash_count')
    plt.plot(count,data1,color='green', label='color1')
    plt.plot(count,data2,color='black', label='color2')
    plt.plot(count,data3,color='red', label='color3')
