...
class Rect_Model():
    ...
    def update(self):        
        ...
        elif self.model.x >= (W-30): self.model.x = W - 30
        if self.model.y <= 0: self.model.y = 0
        elif self.model.y >= (H-30): self.model.y = H - 30
...
def game_init():
    ...
    cell1 = Rect_Model('cell1', (0,255,0), cell1_pos)
    cell2_pos = Point(0,H/2-size)
    cell2 = Rect_Model('cell2', (50,50,50), cell2_pos)
    cell3_pos = Point(W,H/2-size)
    cell3 = Rect_Model('cell3', (255,0,0), cell3_pos)
